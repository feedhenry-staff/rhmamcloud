...
module.exports = function(grunt) {
    ...
    env : {
      ...
      local: {
        ...
        FH_SERVICE_MAP: function() {
           ...
           */
          var serviceMap = {
            'ykYglIhcYicugwxP5-B_dy1p': 'http://127.0.0.1:8002',
            'SERVICE_GUID_2': 'https://host-and-path-to-service'
          };
          return JSON.stringify(serviceMap);
        },
        FH_APP_API_KEY:"b49b14bc115669ead218de50ec79a5c3a8eb9394"
      }
    },
    'node-inspector': {
      dev: {}
  ...
  // Testing tasks
  grunt.registerTask('t', ['env:local', 'shell:js']);
